...
def draw_choice_buttons():
    """
    Draws the choice buttons for selecting X or O.
    """

    font = pygame.font.Font(None, 36)
    x_text = font.render("Choose X", True, BG_COLOR)
    o_text = font.render("Choose O", True, BG_COLOR)

    x_button_rect = x_text.get_rect(center=(WIDTH // 4, HEIGHT // 2))
    o_button_rect = o_text.get_rect(center=(WIDTH * 3 // 4, HEIGHT // 2))

    pygame.draw.rect(screen, X_COLOR, x_button_rect)
    pygame.draw.rect(screen, O_COLOR, o_button_rect)

    screen.blit(x_text, x_button_rect)
    screen.blit(o_text, o_button_rect)
...
def display_result_box(message):
    ...
    Parameters:
    - message: The message to be displayed in the result box.
    """

    pygame.draw.rect(screen, RESULT_BOX_COLOR, (100, HEIGHT // 2 - 40, 440, 80))
    font = pygame.font.Font(None, 36)
    text = font.render(message, True, BG_COLOR)
